/* eslint-disable */
/* @original script - https://github.com/react-boilerplate/react-boilerplate/blob/master/internals/scripts/extract-intl.js */
...
const pkg = require('../../package.json'); // correct_path to package.json
const presets = pkg.babel.presets;
const plugins = pkg.babel.plugins || [];

export const SUPPORTED_LOCALES = [
    "en", "ru"
]; // correct list of supported locals
 ...
 * correct name of the package where defineMessages imported from;
 */
